    ...
    return {
      ...
      qa: [
        ...
        },
        {
          ...
          answer: 'Если у вас срочный заказ, к вам отправляется ближайший курьер; как правило, он приезжает в течение часа и сразу направляется к получателю. Также можно заказать доставку к определенному времени, на определенную дату.'
        },
        {
        ...
        },
        {
          ...
          answer: 'На данный момент курьерская служба «Место» доступна в Санкт-Петербурге, Москве и ленинградской области. В этом году сервис станет также доступен в нескольких других крупных городах.'
        },
        {
